...
namespace Microsoft.Phone.Controls
{
    ...
    /// on elements.
    /// </summary>
    [System.Obsolete("GestureService is obsolete beginning in Windows Phone 8, as the built-in manipulation and gesture events on UIElement now have functional parity with it.")]
    public static class GestureService
    {
        ...
        {
            GestureListener.Initialize(obj);
